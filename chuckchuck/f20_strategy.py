...
- what 과 add 에는 괄호 숫자를 넣지 않는다. 장 번호는 slides 가, 시간은 from/to 가 이미 말한다.
  ...
  "S03"·"S07" 같은 코드 표기는 어떤 문장에도 쓰지 않는다 — 화면 어디서나 "N번 슬라이드" 로만 부른다.
...
JSON 만 출력한다. 아래는 전혀 다른 발표(물류 비용 보고)의 예시로, 짜임새와 말투만 본보기다:
{
  "chosen": {
    "type": "잡스식 축 고정형",
    "why": "7번 슬라이드 창고 이야기에 4:10 을 써서 권장 1:30 의 세 배를 넘겼어요.",
    "outline": [
    ...
    "gains": [
      ...
      {"claim": "창고 이야기가 절반으로 줄어요.",
       "evidence": "7번 슬라이드 창고 이야기에 4:10 을 써서 권장 1:30 의 세 배를 넘겼어요."}
    ]
  },
  "alternatives": [
